...
from GiftLibrary import Ui_MainWindow

#ui,_ = loadUiType('GiftLibrary.ui')
...
class Login(QWidget , Ui_Form):
    ...
    def Handel_Login(self):
        self.db = MySQLdb.connect(host='localhost',user='root',password='Hehaslight11@@',db='library')
...
class MainApp(QMainWindow, Ui_MainWindow):
    ...
    def Handle_buttons(self):
        ...
        self.pushButton_7.clicked.connect(self.Handel_Day_Operations)
    ...
    def Handel_Day_Operations(self):
        ...
        book_type = self.comboBox_4.currentText()
    ...
    def Add_New_Book(self):
        ...
        book_publisher = self.comboBox_2.currentText()
    ...
    def Add_New_Client(self):
        client_name = self.lineEdit_19.text()
        client_email = self.lineEdit_24.text()
        client_nationalid = self.lineEdit_23.text()
